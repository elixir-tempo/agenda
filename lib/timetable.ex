defmodule Timetable do
  ...
  * a sentence naming the resource and every unmet attribute, or
  ...
  @doc """
  Describe an arrangement or an infeasible result as a sentence.

  ### Arguments

  * `result` is a `t:Timetable.Arrangement.t/0` or a
    `t:Timetable.Infeasible.t/0`.
  ...
  * a sentence.
  ...
  """
  @spec explain(Arrangement.t() | Infeasible.t()) :: String.t()
