defmodule Timetable.Arrangement do
  @moduledoc """
  ...
  * the allocated resources, role order preserved.
  ...
  ### Examples
      ...
      iex> arrangement = %Timetable.Arrangement{allocations: %{room: [boardroom]}}
      iex> Enum.map(Timetable.Arrangement.resources(arrangement), & &1.name)
      ["Boardroom"]
  ...
  * a sentence naming the time and the resources.
  ...
  ### Examples
      ...
      ...> }
      iex> Timetable.Arrangement.explain(arrangement)
