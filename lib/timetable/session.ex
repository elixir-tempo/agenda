defmodule Timetable.Session do
  ...
  * a `t:t/0`.
  ...
  ### Examples
      ...
      iex> Timetable.Session.new("Quarterly review", lasting: ~o"PT1H").name
      "Quarterly review"
  ...
  * the session with the requirement added.
  ...
  ### Examples
      ...
      iex> session = Timetable.Session.new("Review")
      iex> session = Timetable.Session.needs(session, :room, seats: at_least(8))
  ...
  * the session with the requirement added.
  ...
  ### Examples
      ...
      iex> session = Timetable.Session.new("Review")
      iex> session = Timetable.Session.roster(session, :attendees, [alice])
      iex> Enum.map(session.requirements, & &1.name)
      [:attendees]
  ...
  * the session, bounded.
  ...
  ### Examples
      ...
      iex> import Tempo.Sigils
      iex> session = Timetable.Session.new("Review")
      iex> Timetable.Session.between(session, ~o"2026-06-15/2026-06-20").window
  ...
  * the session, with its duration set.
  ...
  ### Examples
      ...
      iex> import Tempo.Sigils
      iex> session = Timetable.Session.new("Review")
      iex> Timetable.Session.lasting(session, ~o"PT1H").duration
      ~o"PT1H"
  ...
  * the session, with the preferences added.
  ...
  ### Examples
      ...
      iex> sydney = Timetable.Place.new("Sydney")
      iex> session = Timetable.Session.new("Review")
      iex> Timetable.Session.prefers(session, within: sydney).preferences |> Keyword.keys()
      [:within]
  ...
  * the roster requirements.
  ...
  ### Examples
      ...
      iex> alice = Timetable.Resource.new("Alice")
      iex> session = Timetable.Session.new("Review") |> Timetable.Session.roster(:attendees, [alice])
      iex> Enum.map(Timetable.Session.rosters(session), & &1.name)
      [:attendees]
  ...
  * the attribute requirements.
  ...
  ### Examples
      ...
      iex> session = Timetable.Session.new("Review") |> Timetable.Session.needs(:room, seats: 8)
      iex> Enum.map(Timetable.Session.open_roles(session), & &1.name)
      [:room]
  ...
  see `Timetable.Requirement.induce/2`.
  ...
  * the named resources, in requirement order.
  ...
  ### Examples
      ...
      iex> alice = Timetable.Resource.new("Alice")
      iex> session = Timetable.Session.new("Review") |> Timetable.Session.roster(:attendees, [alice])
      iex> Enum.map(Timetable.Session.named_resources(session), & &1.name)
      ["Alice"]
